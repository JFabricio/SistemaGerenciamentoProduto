...
<h1>Cadastro de Novo Produto</h1><br/>
    <div class="col-md-8">
    <form action="<?php echo e(route('produtos.store')); ?>" class="form-horizontal" method="POST"> <!--Chama a rota que foi definida para todos controlermodelo-->
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/SGProdutos/resources/views/produtos/create.blade.php ENDPATH**/ ?>